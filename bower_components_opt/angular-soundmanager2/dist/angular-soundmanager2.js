    ...
    function($rootScope, $log) {
        ...
        return {
            ...
            initPlayTrack: function(trackId, isResume) {
                ...
                $rootScope.$broadcast('changedIndex',{mindex:trackId,type:0});
            ...
            play: function() {
                ...
                if(this.getCurrentTrack() === null) {
                    ...
                    $rootScope.$broadcast('changedIndex',{mindex:trackToPlay,type:0});
            ...
            nextTrack: function() {
                ...
                $rootScope.$broadcast('changedIndex',{mindex:nextTrackKey,type:1});
            ...
            prevTrack: function() {
                ...
                $rootScope.$broadcast('changedIndex',{mindex:prevTrackKey,type:1});
